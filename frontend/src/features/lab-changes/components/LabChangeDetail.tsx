...
import { Button, Card, Descriptions, Input, Space, Steps, Tag, message } from "antd";
...
export function LabChangeDetail() {
  ...
  return (
    <Card
      ...
      extra={<Button onClick={() => navigate("/lab-changes")}>返回列表</Button>}
    >
      <Steps
      ...
      {data.approval_records.length > 0 && (
        <Card type="inner" title="审批记录" style={{ marginBottom: 24 }}>
