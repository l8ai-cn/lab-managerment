...
class InstrumentStatusLog(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUIDType, primary_key=True, default=uuid.uuid4)
    instrument_id: Mapped[uuid.UUID] = mapped_column(UUIDType, ForeignKey("instruments.id"), index=True)
    ...
    changed_by: Mapped[uuid.UUID | None] = mapped_column(UUIDType)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)
...
class InstrumentBookingRule(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUIDType, primary_key=True, default=uuid.uuid4)
    instrument_id: Mapped[uuid.UUID] = mapped_column(UUIDType, ForeignKey("instruments.id"), unique=True, index=True)
    open_hours: Mapped[dict] = mapped_column(JSONType, default=dict)  # {mon:[{start,end}],...}
    ...
    internal_rules: Mapped[dict | None] = mapped_column(JSONType, default=dict)
    external_rules: Mapped[dict | None] = mapped_column(JSONType, default=dict)
...
class InstrumentBookingApproval(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUIDType, primary_key=True, default=uuid.uuid4)
    booking_id: Mapped[uuid.UUID] = mapped_column(UUIDType, ForeignKey("instrument_bookings.id"), index=True)
...
class InstrumentUsageRecord(Base):
    ...
    id: Mapped[uuid.UUID] = mapped_column(UUIDType, primary_key=True, default=uuid.uuid4)
    booking_id: Mapped[uuid.UUID] = mapped_column(UUIDType, ForeignKey("instrument_bookings.id"), unique=True)
