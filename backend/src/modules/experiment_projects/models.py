...
class ExperimentProject(Base):
    ...
    instruments_needed: Mapped[list | None] = mapped_column(JSONB, default=list)
    consumables: Mapped[list | None] = mapped_column(JSONB, default=list)
    majors: Mapped[list | None] = mapped_column(JSONB, default=list)
