...
|------|------|------|------|
| 0.1 | 项目脚手架 | 全局 | ✅ 已完成 |
| 0.2 | 空间管理（楼栋/楼层/房间） | M09 | 🔄 进行中 |
| 0.3 | 实验室基本信息 CRUD | M01.1 | 🔄 进行中 |
| 0.4 | 实验室多维筛选 | M01.1 | 🔄 进行中 |
| 0.5 | 实验室 Excel 导入导出 | M01.1 | 📋 骨架 |
| 0.6 | 实验员管理与实验室绑定 | M01.3 | 📋 待开发 |
| 0.7 | 实验室变更申请与审批 | M01.2 | 📋 待开发 |
| 0.8 | 用户管理与 RBAC | M09 | 📋 待开发 |
